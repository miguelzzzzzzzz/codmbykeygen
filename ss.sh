# This loader writes the payload to a temporary file, executes it, and cleans up.
# Designed for direct pasting into a shell.

PAYLOAD_PATH="/data/local/tmp/adis_core.sh"
...
echo "\n${RED}${BOLD}CRITICAL SYSTEM WARNING${RESET}"
echo "${YELLOW}This process will permanently alter device identifiers."
echo "Interrupting this process may result in system corruption."
echo "The operation will begin automatically in 5 seconds...${RESET}"
sleep 5
